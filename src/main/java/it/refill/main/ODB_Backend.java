 ...
 * @author rcosco
 */
public class ODB_Backend extends javax.swing.JFrame {
...
//        elencotabelle.add("valute_tagli");
            ...
            for (int i = 0; i < elencotabelle.size(); i++) {
                ...
                if (tablename.equals("anagrafica_client")
                    ...
                    if (tablename.equals("ch_transaction_doc") || tablename.equals("ch_transaction_client")
    ...
    public boolean eseguiresettabelleFIN(ODB_Db dbfiliale, ArrayList<String> elencotabelle) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ODB_Backend.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ODB_Backend().setVisible(true);
            }
        });
    }
