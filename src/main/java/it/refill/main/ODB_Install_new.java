...
import it.refill.engine.Utility;
...
import static it.refill.engine.Utility.hostPROD;
import static it.refill.engine.Utility.hostTEST;
 ...
 * @author rcosco
 */
public class ODB_Install_new extends javax.swing.JFrame {

    /**
     * Creates new form Install
     */
    public ODB_Install_new() {
        initComponents();
    ...
    private void initComponents() {
        ...
        f1ok.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/ok-icon.png"))); // NOI18N

        f1ko.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/Actions-window-close-icon.png"))); // NOI18N

        f2ok.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/ok-icon.png"))); // NOI18N

        f2ko.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/Actions-window-close-icon.png"))); // NOI18N

        f3ok.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/ok-icon.png"))); // NOI18N

        f3ko.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/Actions-window-close-icon.png"))); // NOI18N

        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/logocl.png"))); // NOI18N
    ...
    public boolean fase_UNO(String database, String hostfiliale, String filiale) {
        ...
        if (database.equalsIgnoreCase("PRODUZIONE")) {
            ...
            db = new ODB_Db(hostPROD, false);
        } else {
            db = new ODB_Db(hostTEST, false);
        }
        ...
        elencotabelle.forEach(table -> {
            ...
            try {
                ...
                if (rs != null) {
                    ...
                    insert += ")";
                    ODB_Db dbfiliale = new ODB_Db(hostfiliale, true);
    ...
    private void faseunojButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_faseunojButtonActionPerformed
        ...
        ODB_Db db1;
        if (database.equalsIgnoreCase("PRODUZIONE")) {
            db1 = new ODB_Db(hostPROD, false);
        } else {
            db1 = new ODB_Db(hostTEST, false);
        }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new ODB_Install_new().setVisible(true);
        });
